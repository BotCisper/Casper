...
܁𖠐︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")".."\n"..text.."")
return false
end
...
܁𖠐︙المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")".."\n"..text)
return false
end
...
܁𖠐︙ لا يمكن الوصول لمعلومات الشخص")
end
end,nil)   
end
...
if Type == "kick" then 
Send_Options(msg,msg.sender_user_id_,"reply","

܁𖠐︙قام بالتكرار هنا وتم طرده")  
...
܁𖠐︙قام بالتكرار هنا وتم تقييده")  
return false  
end  
if Type == "mute" then
Send_Options(msg,msg.sender_user_id_,"reply","

܁𖠐︙قام بالتكرار هنا وتم كتمه")  
redis:sadd(bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_) 
return false  
end
end  
...
܁𖠐︙عذرا الملف ليس بصيغة ال : Json*")
return false
end
-- if tonumber(JsonFile:match('(%d+)')) ~= tonumber(bot_id) then 
-- send(chat,msg.id_,"

܁𖠐︙الملف لا يتوافق مع البوت يرجى رفع ملف نسخة الكروبات الحقيفي")   
-- return false 
-- end      
...
܁𖠐︙جاري بدء رفع الكروبات وتحويل الخزن ...")   
...
܁𖠐︙عذرا البوت ليس ادمن يرجى ترقيتي والمحاوله لاحقا") 
redis:del(bot_id.."Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"

܁𖠐︙ليس لدي صلاحية تغيير معلومات المجموعه يرجى المحاوله لاحقا") 
redis:del(bot_id.."Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
else
send(msg.chat_id_, msg.id_,"

܁𖠐︙تم تغيير صورة المجموعه") 
end
end, nil) 
redis:del(bot_id.."Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
end   
...
܁𖠐︙تمت الاذاعه الى *- "..#list.." * مجموعه في البوت ")     
if msg.content_.text_ then
for k,v in pairs(list) do 
...
܁𖠐︙تمت الاذاعه الى *- "..#list.." * مشترك في البوت ")     
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]")  
end
...
܁𖠐︙تم التوجيه الى *- "..#list.." * مجموعه في البوت ")     
for k,v in pairs(list) do  
...
܁𖠐︙عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false  end 
...
܁𖠐︙مبروك فزت ويانه وخمنت الرقم الصحيح\n
...
܁𖠐︙عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى\n")
return false  end 
...
܁𖠐︙مبروك فزت وطلعت المحيبس بل ايد رقم { "..NUM.." }\n
...
܁𖠐︙ارسل التحذير عند ارسال الكلمه")  
...
܁𖠐︙تم تحديث السورس وتنزيل اخر تحديث للملفات")
elseif text == 'تحديث السورس' then
download_to_file('https://raw.githubusercontent.com/Casperkid/Casper/master/Casper.lua','Casper.lua') 
download_to_file('https://raw.githubusercontent.com/Casperkid/Casper/master/Script.lua','Script.lua') 
send(msg.chat_id_, msg.id_, "
...
܁𖠐︙ لا يوجد اتصال من ال api") 
end
elseif text == "مسح جميع الملفات" then
os.execute("rm -fr Files/*")
send(msg.chat_id_,msg.id_,"

܁𖠐︙تم مسح جميع ملفات المفعله")
...
܁𖠐︙تم الغاء حفظ كليشه امر /start") 
...
܁𖠐︙تم حفظ كليشه امر /start في البوت') 
redis:del(bot_id..'Set:Cmd:Start:Bots') 
return false
end
------------------------------------------------------------------------------------------------------------
...
܁𖠐︙تم ارسال رسالتك الى المطور ← { ['..UserName_Dev..'] }')    
...
Send_Optionspv(Id_Dev,0,msg.sender_user_id_,"reply_Pv","
...
if text == 'حظر' then
Send_Optionspv(Id_Dev,msg.id_,UserForward,"reply_Pv","

܁𖠐︙تم حظره من تواصل البوت")  
redis:sadd(bot_id..'User:Ban:Pv',data.id_)  
return false  
elseif text =='الغاء الحظر' then
Send_Optionspv(Id_Dev,msg.id_,UserForward,"reply_Pv","

܁𖠐︙تم الغاء حظره من تواصل البوت")  
...
܁𖠐︙قام بحظر البوت لا تستطيع ارسال له رسائل")  
return false  
end 
if text then    
...
܁𖠐︙تم الغاء حظره عام من المجموعات")  
...
܁𖠐︙ تم تعيين عدد اعضاء تفعيل البوت اكثر من : '..text:match("تعين عدد الاعضاء (%d+)$")..' عضو *')
...
܁𖠐︙لا يوجد مشتركين وهميين')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'*

܁𖠐︙عدد المشتركين الان ←{ '..#pv..' }\n
...
܁𖠐︙ عدد المجموعات الان ← { '..#group..' } مجموعه '..Casper..''..taha..'\n
...
Send_Options(msg,text:match("^اضف مطور (%d+)$"),"reply","
...
Send_Options(msg,text:match("^حذف مطور (%d+)$"),"reply","
...
܁𖠐︙ تم مسح المنشئين الاساسيين في المجموعه")
...
܁𖠐︙ تم مسح المكتومين في المجموعه")
...
܁𖠐︙تم مسح المحظورين في المجموعه")
...
܁𖠐︙تم مسح جميع الاوامر التي تم اضافتها")  
...
܁𖠐︙لا تستطيع رفع احد وذالك لان تم تعطيل الرفع من قبل المنشئين')
return false
end
function FunctionStatus(arg, result)
...
܁𖠐︙تم تنزيله من ادمنيه المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
܁𖠐︙لقد تم تعطيل الحظر و الطرد من قبل المنشئين')
return false
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,"

܁𖠐︙عذرآ البوت ليس ادمن") 
return false  
end
function FunctionStatus(arg, result)
...
܁𖠐︙لا توجد لدي صلاحية حظر المستخدمين") 
return false  
end
...
܁𖠐︙لا يمكنك عمل هاذا الامر على البوت") 
return false 
end
...
܁𖠐︙تم تقيده لمدة ~ { "..TextEnd[2]..' '..TextEnd[3]..'}')
...
Send_Options(msg,text:match("^حظر عام (%d+)$"),"reply","
...
Send_Options(msg,text:match("^الغاء العام (%d+)$"),"reply","
...
Send_Options(msg,text:match("^رفع منشئ اساسي (%d+)$") ,"reply","
...
Send_Options(msg,text:match("^تنزيل منشئ اساسي (%d+)$") ,"reply","
...
Send_Options(msg,text:match("^رفع منشئ (%d+)$"),"reply","
...
Send_Options(msg,text:match("^تنزيل منشئ (%d+)$"),"reply","
...
Send_Options(msg,text:match("^رفع مدير (%d+)$") ,"reply","
...
Send_Options(msg,text:match("^تنزيل مدير (%d+)$") ,"reply","
...
Send_Options(msg,text:match("^رفع ادمن (%d+)$"),"reply","
...
Send_Options(msg,text:match("^تنزيل ادمن (%d+)$"),"reply","
...
Send_Options(msg,text:match("^رفع مميز (%d+)$"),"reply","
...
Send_Options(msg,text:match("^تنزيل مميز (%d+)$") ,"reply","
...
Send_Options(msg,text:match("^حظر (%d+)$") ,"reply","
...
Send_Options(msg,text:match("^الغاء حظر (%d+)$") ,"reply","
...
Send_Options(msg,text:match("^كتم (%d+)$"),"reply","
...
Send_Options(msg,text:match("^الغاء كتم (%d+)$") ,"reply","
...
Send_Options(msg,text:match("^تقيد (%d+)$"),"reply","
...
Send_Options(msg,text:match("^الغاء تقيد (%d+)$"),"reply","
...
Send_Options(msg,text:match("^طرد (%d+)$") ,"reply","
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","
...
Send_Options(msg,msg.sender_user_id_,"Close_Status_Kick","
...
Send_Options(msg,msg.sender_user_id_,"Close_Status_Kid","

܁𖠐︙تم قفـل الروابط")  
elseif text == "قفل الروابط بالكتم" and Admin(msg) then
redis:set(bot_id.."Status:Lock:Link"..msg.chat_id_,"ktm")  
Send_Options(msg,msg.sender_user_id_,"Close_Status_Ktm","
...
܁𖠐︙تم الغاء تثبيت الرساله بنجاح")   
...
܁𖠐︙تم وضع عدد التكرار : "..text:match("^وضع تكرار (%d+)$").."")  
...
܁𖠐︙تم وضع زمن التكرار : "..text:match("^وضع زمن التكرار (%d+)$").."") 
elseif text == "ضع رابط" and Admin(msg) or text == "وضع رابط" and Admin(msg) then
send(msg.chat_id_,msg.id_,"

܁𖠐︙ارسل رابط المجموعه او رابط قناة المجموعه")
...
܁𖠐︙ البوت ليس ادمن يرجى ترقيتي !")  
return false  
end 
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"

܁𖠐︙ ليست لدي صلاحية تغير اسم المجموعه")  
else
send(msg.chat_id_,msg.id_,"

܁𖠐︙ تم تغيير اسم المجموعه الى {["..Name.."]}")  
end
end,nil) 
...
܁𖠐︙ارسل الان الامر الذي قمت بوضعه مكان الامر القديم")  
...
܁𖠐︙ تم تغير رد المنشئ الاساسي الى :"..Teext)
...
܁𖠐︙ لا تستطيع تنزيل المطور الاساسي")
return false 
end
...
܁𖠐︙ رتبتك في البوت : "..rtp)
elseif text == "اسمي"  then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
if result.first_name_  then
first_name = "

܁𖠐︙ اسمك الاول : `"..(result.first_name_).."`"
else
first_name = ""
end   
...
܁𖠐︙ اسمك الثاني ← : `"..result.last_name_.."`" 
else
last_name = ""
end      
...
܁𖠐︙ عدد الادمنيه : "..data.administrator_count_..
"\n
...
܁𖠐︙ تم مغادرة المجموعه بامر من مطور البوت") 
...
܁𖠐︙تم تعطيل الاذاعه من قبل المطور الاساسي !")
return false end
redis:setex(bot_id.."Broadcasting:Users" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"
...
܁𖠐︙ تم تغير الايدي ارسل ايدي لرؤيته')
end
...
܁𖠐︙تم ازالة *- '..Msg_Num..'* رساله من المجموعه')  
...
܁𖠐︙ الحساب محذوف لا توجد معلوماته ')
return false
end
if data.username_ then
UserName_User = '@'..data.username_
...
܁𖠐︙اسرع واحد يدز هاذا السمايل ? ~ {`"..SM.."`}")
return false
end
...
܁𖠐︙اسرع واحد يدز معنى السمايل ~ {"..name.."}")
return false
end
...
܁𖠐︙اختر لأستخراج المحيبس الايد التي تحمل المحيبس 


܁𖠐︙الفائز يحصل على { 3 } من النقاط *
]])
...
܁𖠐︙بيع مجوهراتي ← { العدد } ← لبيع كل مجوهره مقابل {50} رساله
*]]) 
...
܁𖠐︙تم اضافه عدد الرسائل : "..text:match("^اضف رسائل (%d+)$").." ")  
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},reply, nil)
return false
...
܁𖠐︙ ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !") 
return false  
end
...
܁𖠐︙ عذرا لا استطيع طرد ادمنية المجموعه") 
return false  
end
if data and data.ID and data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"

܁𖠐︙ تم طردك من المجموعه ") 
...
܁𖠐︙ امر اطردني تم تعطيله من قبل المدراء ") 
end
...
܁𖠐︙ لا توجد ادمنية ليتم رفعهم") 
else
send(msg.chat_id_, msg.id_,"

܁𖠐︙ تمت ترقية - "..num2.." من ادمنية المجموعه") 
end
end,nil)   
...
܁𖠐︙منشئ المجموعه ~ ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
܁𖠐︙تم ترقية منشئ المجموعه ← ["..b.first_name_.."](T.me/"..UserName..")")  
...
܁𖠐︙لا تستطيع تفعيل المجموعه بسبب قلة عدد اعضاء المجموعه يجب ان يكون اكثر من *:'..(redis:get(bot_id..'Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
...
Send_Options(msg,result.id_,'reply_Add','

܁𖠐︙تم تفعيل مجموعه '..chat.title_..'')
...
܁𖠐︙المجموعه بالتاكيد معطله')
else
Send_Options(msg,result.id_,'reply_Add','

܁𖠐︙تم تعطيل مجموعه '..chat.title_..'')
redis:srem(bot_id..'ChekBotAdd',msg.chat_id_)  
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub('"',"") 
...
Send_Options(msg,msg.sender_user_id_,'reply_Add','
...
܁𖠐︙تم ازالة هاذا ← { "..text.." }")  
else
send(msg.chat_id_, msg.id_,"

܁𖠐︙لا يوجد امر بهاذا الاسم")  
end
...
܁𖠐︙ارسل الامر الجديد ليتم وضعه مكان القديم")  
...
if #list == 0 then
Send_Options(result,result.sender_user_id_,"reply","
