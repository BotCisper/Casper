...
io.write('\n\27[1;35m܁𖠐︙Send Token For Bot : ارسل توكن البوت ...\n\27[0;39;49m')
local token = io.read()
if token ~= '' then
...
send(msg.chat_id_, msg.id_,"܁𖠐︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")".."\n"..text.."")
return false
end
...
send(msg.chat_id_, msg.id_,"܁𖠐︙المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")".."\n"..text)
return false
end
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ لا يمكن الوصول لمعلومات الشخص")
end
end,nil)   
end
...
send(chat,idmsg,"܁𖠐︙المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")".."\n"..text)
return false
end
else
send(chat,idmsg,"܁𖠐︙ لا يمكن الوصول لمعلومات الشخص")
end
end,nil)   
end
------------------------------------------------------------------------------------------------------------
...
if Type == "kick" then 
Send_Options(msg,msg.sender_user_id_,"reply","܁𖠐︙قام بالتكرار هنا وتم طرده")  
...
Send_Options(msg,msg.sender_user_id_,"reply","܁𖠐︙قام بالتكرار هنا وتم تقييده")  
return false  
end  
if Type == "mute" then
Send_Options(msg,msg.sender_user_id_,"reply","܁𖠐︙قام بالتكرار هنا وتم كتمه")  
redis:sadd(bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_) 
return false  
end
end  
...
send(chat,msg.id_,"*܁𖠐︙عذرا الملف ليس بصيغة ال : Json*")
return false
end
-- if tonumber(JsonFile:match('(%d+)')) ~= tonumber(bot_id) then 
-- send(chat,msg.id_,"܁𖠐︙الملف لا يتوافق مع البوت يرجى رفع ملف نسخة الكروبات الحقيفي")   
-- return false 
-- end      
local File = json:decode(https.request('https://api.telegram.org/bot'..token..'/getfile?file_id='..File_id) ) 
download_to_file('https://api.telegram.org/file/bot'..token..'/'..File.result.file_path,''..JsonFile) 
send(chat,msg.id_,"܁𖠐︙جاري بدء رفع الكروبات وتحويل الخزن ...")   
...
send(chat,msg.id_,"܁𖠐︙تم رفع ملف الخزن بنجاح\n܁𖠐︙تم استرجاع جميع الكروبات ورفع المنشئين والمدراء في البوت")   
end
------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,'\n܁𖠐︙الكانسر مقفول يرجى زغرفه اسمك اولاً\n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉\n[܁𖠐︙ اضغط هنا لزغرفه اسمك.](https://t.me/SJAIBot)')
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..msg.sender_user_id_)
end
end,nil)   
return false
...
send(msg.chat_id_, msg.id_,"܁𖠐︙عذرا البوت ليس ادمن يرجى ترقيتي والمحاوله لاحقا") 
redis:del(bot_id.."Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"܁𖠐︙ليس لدي صلاحية تغيير معلومات المجموعه يرجى المحاوله لاحقا") 
redis:del(bot_id.."Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
else
send(msg.chat_id_, msg.id_,"܁𖠐︙تم تغيير صورة المجموعه") 
end
end, nil) 
redis:del(bot_id.."Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
end   
...
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_,msg.id_, "\n܁𖠐︙تم الغاء الاذاعه بالتوجيه للمجموعات") 
redis:del(bot_id.."Broadcasting:Groups:Fwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = redis:smembers(bot_id.."ChekBotAdd")   
send(msg.chat_id_, msg.id_,"܁𖠐︙تم التوجيه الى *- "..#list.." * مجموعه في البوت ")     
for k,v in pairs(list) do  
...
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_,msg.id_, "\n܁𖠐︙تم الغاء الاذاعه بالترجيه خاص") 
...
send(msg.chat_id_,msg.id_,"܁𖠐︙تم حفظ الرابط بنجاح")       
redis:del(bot_id.."Status:link:set"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
end 
...
if Text_Filter then    
Send_Options(msg,msg.sender_user_id_,"reply","܁𖠐︙"..Text_Filter)  
Delete_Message(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
...
send(msg.chat_id_, msg.id_, "\n܁𖠐︙تم اضافة الصلاحيه باسم ← { "..textn..' }') 
redis:del(bot_id.."Redis:Validity:Group"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
send(msg.chat_id_, msg.id_,"\n܁𖠐︙لقد فزت في اللعبه \n܁𖠐︙اللعب مره اخره وارسل - سمايل او سمايلات")
...
send(msg.chat_id_, msg.id_,"\n܁𖠐︙لقد فزت في اللعبه \n܁𖠐︙اللعب مره اخره وارسل - الاسرع او ترتيب")
redis:incrby(bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_, msg.id_,"܁𖠐︙عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false  end 
...
send(msg.chat_id_, msg.id_,"܁𖠐︙مبروك فزت ويانه وخمنت الرقم الصحيح\n܁𖠐︙تم اضافة { 5 } من النقاط \n")
...
redis:del(bot_id.."Status:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
redis:del(bot_id.."Status:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,"܁𖠐︙اوبس لقد خسرت في اللعبه \n܁𖠐︙حظآ اوفر في المره القادمه \n܁𖠐︙كان الرقم الذي تم تخمينه { "..GETNUM.." }")
else
send(msg.chat_id_, msg.id_,"܁𖠐︙اوبس تخمينك غلط \n܁𖠐︙ارسل رقم تخمنه مره اخرى ")
end
end
end
end
...
send(msg.chat_id_, msg.id_,"܁𖠐︙عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى\n")
return false  end 
...
send(msg.chat_id_, msg.id_,"܁𖠐︙مبروك فزت وطلعت المحيبس بل ايد رقم { "..NUM.." }\n܁𖠐︙لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل ")
redis:incrby(bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
redis:del(bot_id.."Status:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,"܁𖠐︙للاسف لقد خسرت \n܁𖠐︙المحيبس بل ايد رقم { "..GETNUM.." }\n܁𖠐︙حاول مره اخرى للعثور على المحيبس")
end
end
end
------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,"\n܁𖠐︙لقد فزت في اللعبه \n܁𖠐︙اللعب مره اخره وارسل - المختلف")
redis:incrby(bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_,msg.id_,"\n܁𖠐︙تم اضافة له - "..numadded.." مجوهرات")  
end
------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم حفظ قوانين المجموعه") 
redis:del(bot_id.."Redis:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
------------------------------------------------------------------------------------------------------------
if text then 
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم الغاء منعها ")  
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ارسل التحذير عند ارسال الكلمه")  
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم منع الكلمه مع التحذير")  
redis:del(bot_id.."Filter:Reply1"..msg.sender_user_id_..msg.chat_id_)  
...
send(msg.chat_id_,msg.id_,'܁𖠐︙تم الغاء حفظ كليشة المطور')
return false
end
redis:set(bot_id..'Texting:DevCasper',text)
redis:del(bot_id..'GetTexting:DevCasper'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'܁𖠐︙تم حفظ كليشة المطور')
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم حفظ رد للمدير بنجاح \n܁𖠐︙ارسل ( "..test.." ) لرئية الرد")
return false  
end  
end
------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, '\n܁𖠐︙ارسل لي الرد لاضافته\n܁𖠐︙تستطيع اضافة ← { ملف ، فديو ، نص ، ملصق ، بصمه ، متحركه }\n܁𖠐︙تستطيع ايضا اضافة :\n܁𖠐︙`#username` » معرف المستخدم \n܁𖠐︙`#msgs` » عدد الرسائل\n܁𖠐︙`#name` » اسم المستخدم\n܁𖠐︙`#id` » ايدي المستخدم\n܁𖠐︙`#stast` » موقع المستخدم \n܁𖠐︙`#edit` » عدد السحكات ')
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم حذف الرد من ردود المدير ")
redis:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
redis:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
redis:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
redis:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم حفظ رد للمطور \n܁𖠐︙ارسل ( "..test.." ) لرئية الرد")
return false  
end  
end
------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم حذف الرد من ردود المطور")
...
dofile("Casper.lua")  
send(msg.chat_id_, msg.id_, "܁𖠐︙تم تحديث ملفات البوت")
...
send(msg.chat_id_, msg.id_, "܁𖠐︙تم تحديث السورس وتنزيل اخر تحديث للملفات")
elseif text == 'تحديث السورس' then
download_to_file('https://raw.githubusercontent.com/Casperkid/Casper/master/Casper.lua','Casper.lua') 
download_to_file('https://raw.githubusercontent.com/Casperkid/Casper/master/Script.lua','Script.lua') 
send(msg.chat_id_, msg.id_, "܁𖠐︙تم تحديث السورس وتنزيل اخر تحديث للملفات")
...
if i == 0 then
Files = '܁𖠐︙ لا توجد ملفات في البوت '
end
...
if Get_info then
local TextS = "\n܁𖠐︙قائمه ملفات متجر سورس Casper\n܁𖠐︙الملفات المتوفره حاليا\n━━━━━━━━━━━━━\n\n"
local TextE = "\n━━━━━━━━━━━━━\n܁𖠐︙علامة ← {✔} تعني الملف مفعل\n܁𖠐︙علامة ← {❌} تعني الملف معطل\n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ لا يوجد اتصال من ال api") 
end
elseif text == "مسح جميع الملفات" then
os.execute("rm -fr Files/*")
send(msg.chat_id_,msg.id_,"܁𖠐︙تم مسح جميع ملفات المفعله")
...
send(msg.chat_id_, msg.id_,"\n܁𖠐︙الملف ← *"..File_Name.."*\n܁𖠐︙تم تعطيله وحذفه من البوت بنجاح") 
dofile('Casper.lua')  
else
send(msg.chat_id_, msg.id_,"܁𖠐︙لا يوجد ملف بهاذا الاسم") 
end
...
if text == 'الغاء ✖' then   
send(msg.chat_id_, msg.id_,"܁𖠐︙تم الغاء حفظ كليشه امر /start") 
redis:del(bot_id..'Set:Cmd:Start:Bots') 
return false
end
redis:set(bot_id.."Set:Cmd:Start:Bot",text)  
send(msg.chat_id_, msg.id_,'܁𖠐︙تم حفظ كليشه امر /start في البوت') 
redis:del(bot_id..'Set:Cmd:Start:Bots') 
return false
end
------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_,msg.id_,'\n܁𖠐︙عليك الاشتراك في قناة البوت \n܁𖠐︙قناة البوت ← { @Cispar }') 
return false
end
if Dev_Casper(msg) then
local Text_keyboard = '܁𖠐︙اهلا بيك عزيزي ⸼ .\n܁𖠐︙انت المطور الاساسي للبوت 𖧧.\n܁𖠐︙تستطيع التحكم باوامر البوت 𖧧.\n܁𖠐︙من خلال الكيبورد الخاص بك 𖧧.\n܁𖠐︙قناة السورس ◝ @Cispar ◟ .'
local List_keyboard = {
...
CmdStart = '\n܁𖠐︙أهلآ بك في بوت '..Name_Bot..''..
'\n܁𖠐︙اختصاص البوت حماية المجموعات'..
'\n܁𖠐︙لتفعيل البوت عليك اتباع مايلي ...'..
'\n܁𖠐︙اضف البوت الى مجموعتك'..
'\n܁𖠐︙ارفعه ادمن {مشرف}'..
'\n܁𖠐︙ارسل كلمة { تفعيل } ليتم تفعيل المجموعه'..
'\n܁𖠐︙سيتم ترقيتك منشئ اساسي في البوت'..
'\n܁𖠐︙مطور البوت ← {['..UserName_Dev..']}'
...
send(msg.sender_user_id_,msg.id_,'܁𖠐︙تم ارسال رسالتك الى المطور ← { ['..UserName_Dev..'] }')    
...
Send_Optionspv(Id_Dev,0,msg.sender_user_id_,"reply_Pv","܁𖠐︙قام بارسال الملصق")  
return false
end
end
end,nil)
...
if text == 'حظر' then
Send_Optionspv(Id_Dev,msg.id_,UserForward,"reply_Pv","܁𖠐︙تم حظره من تواصل البوت")  
redis:sadd(bot_id..'User:Ban:Pv',data.id_)  
return false  
elseif text =='الغاء الحظر' then
Send_Optionspv(Id_Dev,msg.id_,UserForward,"reply_Pv","܁𖠐︙تم الغاء حظره من تواصل البوت")  
...
Send_Optionspv(Id_Dev,msg.id_,UserForward,"reply_Pv","܁𖠐︙قام بحظر البوت لا تستطيع ارسال له رسائل")  
return false  
end 
if text then    
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ارسل لي التوجيه الان\n܁𖠐︙ليتم نشره في المجموعات") 
return false
...
send(msg.chat_id_,msg.id_,"܁𖠐︙عذرا هاذا معرف قناة")   
return false 
end      
if tonumber(result.id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "܁𖠐︙لا تسطيع حظر البوت عام")
return false 
end
if Dev_Casper_User(result.id_) == true then
send(msg.chat_id_, msg.id_, "܁𖠐︙لا تستطيع حظر المطور الاساسي عام")
return false 
end
redis:sadd(bot_id.."Removal:User:Groups", result.id_)
Send_Options(msg,result.id_,"reply","܁𖠐︙تم حظره عام من المجموعات")  
else
send(msg.chat_id_, msg.id_,"܁𖠐︙المعرف غلط ")
end
end
...
function FunctionStatus(arg, result)
if (result.id_) then
Send_Options(msg,result.id_,"reply","܁𖠐︙تم الغاء حظره عام من المجموعات")  
...
Send_Options(msg,result.id_,"reply","܁𖠐︙تم ترقيته مطور في البوت")  
else
send(msg.chat_id_, msg.id_,"܁𖠐︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","܁𖠐︙تم تنزيله من المطورين")  
else
send(msg.chat_id_, msg.id_,"܁𖠐︙المعرف غلط ")
end
end
...
send(msg.chat_id_, msg.id_,'*܁𖠐︙عدد احصائيات البوت الكامله \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n܁𖠐︙عدد المجموعات : '..(redis:scard(bot_id..'ChekBotAdd') or 0)..'\n܁𖠐︙عدد المشتركين : '..(redis:scard(bot_id..'Num:User:Pv') or 0)..'*')
elseif text and text:match("^تعين عدد الاعضاء (%d+)$") then
redis:set(bot_id..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
send(msg.chat_id_, msg.id_,'*܁𖠐︙ تم تعيين عدد اعضاء تفعيل البوت اكثر من : '..text:match("تعين عدد الاعضاء (%d+)$")..' عضو *')
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,'܁𖠐︙لا يوجد مشتركين وهميين')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'*܁𖠐︙عدد المشتركين الان ←{ '..#pv..' }\n܁𖠐︙تم العثور على ←{ '..sendok..' } مشترك قام بحظر البوت\n܁𖠐︙اصبح عدد المشتركين الان ←{ '..ok..' } مشترك *')   
end
end
end,nil)
end,nil)
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'܁𖠐︙لا توجد مجموعات وهميه ')   
else
local taha = (w + q)
...
taha = '\n܁𖠐︙ تم ازالة ~ '..q..' مجموعات من البوت'
end
if w == 0 then
Casper = ''
else
Casper = '\n܁𖠐︙ تم ازالة ~'..w..' مجموعه لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'*܁𖠐︙ عدد المجموعات الان ← { '..#group..' } مجموعه '..Casper..''..taha..'\n܁𖠐︙اصبح عدد المجموعات الان ← { '..sendok..' } مجموعات*\n')   
end
end
end,nil)
end
...
Send_Options(msg,result.sender_user_id_,"reply","܁𖠐︙تم ترقيته مطور في البوت")  
end
...
Send_Options(msg,result.sender_user_id_,"reply","܁𖠐︙تم تنزيله من المطورين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
return false
end
...
if (result.id_) then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"܁𖠐︙عذرا اذا معرف قناة")   
return false 
end      
redis:sadd(bot_id.."Developer:Bot", result.id_)
Send_Options(msg,result.id_,"reply","܁𖠐︙تم ترقيته مطور في البوت")  
...
Send_Options(msg,text:match("^اضف مطور (%d+)$"),"reply","܁𖠐︙تم ترقيته مطور في البوت")  
return false
end
...
Send_Options(msg,text:match("^حذف مطور (%d+)$"),"reply","܁𖠐︙تم تنزيله من المطورين")  
return false
end
...
send(msg.chat_id_, msg.id_, "܁𖠐︙ تم مسح المنشئين الاساسيين في المجموعه")
...
send(msg.chat_id_, msg.id_, "܁𖠐︙ تم مسح المنشئين في المجموعه")
...
send(msg.chat_id_, msg.id_, "܁𖠐︙ تم مسح المدراء في المجموعه")
...
send(msg.chat_id_, msg.id_, "܁𖠐︙ تم مسح الادمنيه في المجموعه")
...
send(msg.chat_id_, msg.id_, "܁𖠐︙ تم مسح المميزين في المجموعه")
...
send(msg.chat_id_, msg.id_, "܁𖠐︙ تم مسح المكتومين في المجموعه")
...
send(msg.chat_id_, msg.id_, "܁𖠐︙تم مسح المحظورين في المجموعه")
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم مسح جميع الاوامر التي تم اضافتها")  
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم مسح صلاحيات المجموعه")
...
Asase = "\n܁𖠐︙قائمة المنشئين الاساسين في المجموعه\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = redis:get(bot_id.."Save:Username" .. v)
if username then
...
if #list == 0 then
Asase = "܁𖠐︙لا يوجد منشئين اساسيين"
end
...
if #list == 0 then
Bans = "܁𖠐︙لا يوجد محظورين"
end
send(msg.chat_id_, msg.id_, Bans)
elseif text == "الصلاحيات" and Admin(msg) then 
local list = redis:smembers(bot_id.."Validitys:Group"..msg.chat_id_)
if #list == 0 then
send(msg.chat_id_, msg.id_,"܁𖠐︙لا توجد صلاحيات مضافه هنا")
return false
end
Validity = "\n܁𖠐︙قائمة الصلاحيات المضافه \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
...
local list = redis:smembers(bot_id.."Command:List:Group"..msg.chat_id_.."")
Command = "܁𖠐︙قائمه الاوامر المضافه  \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
...
if #list == 0 then
Command = "܁𖠐︙لا توجد اوامر اضافيه"
end
...
Send_Options(msg,result.sender_user_id_,"reply","܁𖠐︙تم حظره عام من المجموعات")  
...
Send_Options(msg,result.sender_user_id_,"reply","܁𖠐︙تم الغاء حظره عام من المجموعات")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","܁𖠐︙تم ترقيته منشئ اساسي")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","܁𖠐︙تم تنزيله من المنشئين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","܁𖠐︙تم ترقيته منشئ في المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","܁𖠐︙تم ترقيته مدير المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","܁𖠐︙تم تنزيله من المدراء")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
send(msg.chat_id_, msg.id_,'܁𖠐︙لا تستطيع رفع احد وذالك لان تم تعطيل الرفع من قبل المنشئين')
return false
end
function FunctionStatus(arg, result)
redis:sadd(bot_id.."Admin:Group"..msg.chat_id_, result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","܁𖠐︙تم ترقيته ادمن للمجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","܁𖠐︙تم تنزيله من ادمنيه المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","܁𖠐︙تم ترقيته مميز للمجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","܁𖠐︙تم تنزيله من المميزين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
send(msg.chat_id_, msg.id_,'܁𖠐︙لقد تم تعطيل الحظر و الطرد من قبل المنشئين')
return false
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,"܁𖠐︙عذرآ البوت ليس ادمن") 
return false  
end
function FunctionStatus(arg, result)
if Rank_Checking(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, "\n܁𖠐︙لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(result.sender_user_id_,msg.chat_id_).." ")
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.sender_user_id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,"܁𖠐︙لا توجد لدي صلاحية حظر المستخدمين") 
return false  
end
redis:sadd(bot_id.."Removal:User:Group"..msg.chat_id_, result.sender_user_id_)
KickGroup(result.chat_id_, result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","܁𖠐︙تم حظره من المجموعه")  
end,nil)   
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
function FunctionStatus(arg, result)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, "܁𖠐︙لا يمكنك عمل هاذا الامر على البوت") 
return false 
end
redis:srem(bot_id.."Removal:User:Group"..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
Send_Options(msg,result.sender_user_id_,"reply","܁𖠐︙تم الغاء حظره من هنا")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","܁𖠐︙تم كتمه من هنا")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","܁𖠐︙تم الغاء كتمه من هنا")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","܁𖠐︙تم الغاء تقييده")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","܁𖠐︙تم تقييده")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.id_,"reply","܁𖠐︙تم ترقيته منشئ اساسي")  
else
send(msg.chat_id_, msg.id_,"܁𖠐︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","܁𖠐︙تم تنزيله من المنشئين")  
else
send(msg.chat_id_, msg.id_,"܁𖠐︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","܁𖠐︙تم ترقيته منشئ في المجموعه")  
else
send(msg.chat_id_, msg.id_,"܁𖠐︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","܁𖠐︙تم ترقيته مدير المجموعه")  
else
send(msg.chat_id_, msg.id_,"܁𖠐︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","܁𖠐︙تم تنزيله من المدراء")  
else
send(msg.chat_id_, msg.id_,"܁𖠐︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","܁𖠐︙تم ترقيته ادمن للمجموعه")  
else
send(msg.chat_id_, msg.id_,"܁𖠐︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","܁𖠐︙تم تنزيله من ادمنيه المجموعه")  
else
send(msg.chat_id_, msg.id_,"܁𖠐︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","܁𖠐︙تم ترقيته مميز للمجموعه")  
else
send(msg.chat_id_, msg.id_,"܁𖠐︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","܁𖠐︙تم تنزيله من المميزين")  
else
send(msg.chat_id_, msg.id_,"܁𖠐︙المعرف غلط ")
end
end
...
Send_Options(msg,result.sender_user_id_,"reply","܁𖠐︙تم ترقيته : "..text:match("رفع (.*)").."")  
end   
...
Send_Options(msg,result.sender_user_id_,"reply","܁𖠐︙تم تنزيله : "..text:match("تنزيل (.*)").."")  
end   
tdcli_function ({ ID = "GetMessage", chat_id_ = msg.chat_id_, message_id_ = tonumber(msg.reply_to_message_id_) }, Status_reply, nil)
end
...
Send_Options(msg,result.id_,"reply","܁𖠐︙تم رفعه : "..text1[2].."")
else
send(msg.chat_id_, msg.id_,"܁𖠐︙المعرف غلط")
end
end
...
Send_Options(msg,result.id_,"reply","܁𖠐︙تم تنزيله : "..text1[2].."")
else
send(msg.chat_id_, msg.id_,"܁𖠐︙المعرف غلط")
end
end
...
send(msg.chat_id_, msg.id_, "\n܁𖠐︙لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(result.id_,msg.chat_id_).."")
else
...
Send_Options(msg,result.id_,"reply","܁𖠐︙تم حظره من المجموعه")  
end,nil)   
end
else
send(msg.chat_id_, msg.id_,"܁𖠐︙المعرف غلط ")
...
Send_Options(msg,result.id_,"reply","܁𖠐︙تم الغاء حظره من هنا")  
else
send(msg.chat_id_, msg.id_,"܁𖠐︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","܁𖠐︙تم كتمه من هنا")  
else
send(msg.chat_id_, msg.id_,"܁𖠐︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","܁𖠐︙تم الغاء كتمه من هنا")  
else
send(msg.chat_id_, msg.id_,"܁𖠐︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","܁𖠐︙تم تقييده في المجموعه")  
else
send(msg.chat_id_, msg.id_,"܁𖠐︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply", "܁𖠐︙تم تقيده لمدة ~ { "..TextEnd[2]..' '..TextEnd[3]..'}')
...
Send_Options(msg,result.id_,"reply","܁𖠐︙تم الغاء تقييده")  
else
send(msg.chat_id_, msg.id_,"܁𖠐︙المعرف غلط ")
end
end
...
KickGroup(msg.chat_id_, result.id_)
Send_Options(msg,result.id_,"reply","܁𖠐︙تم طرده من هنا")  
end,nil)   
end
else
send(msg.chat_id_, msg.id_,"܁𖠐︙المعرف غلط ")
...
Send_Options(msg,text:match("^حظر عام (%d+)$"),"reply","܁𖠐︙تم حظره عام من المجموعات")  
...
Send_Options(msg,text:match("^الغاء العام (%d+)$"),"reply","܁𖠐︙تم الغاء حظره عام من المجموعات")  
return false
end
...
Send_Options(msg,text:match("^رفع منشئ اساسي (%d+)$") ,"reply","܁𖠐︙تم ترقيته منشئ اساسي")  
...
Send_Options(msg,text:match("^تنزيل منشئ اساسي (%d+)$") ,"reply","܁𖠐︙تم تنزيله من المنشئين")  
...
Send_Options(msg,text:match("^رفع منشئ (%d+)$"),"reply","܁𖠐︙تم ترقيته منشئ في المجموعه")  
...
Send_Options(msg,text:match("^تنزيل منشئ (%d+)$"),"reply","܁𖠐︙تم تنزيله من المنشئين")  
...
Send_Options(msg,text:match("^رفع مدير (%d+)$") ,"reply","܁𖠐︙تم ترقيته مدير المجموعه")  
...
Send_Options(msg,text:match("^تنزيل مدير (%d+)$") ,"reply","܁𖠐︙تم تنزيله من المدراء")  
...
Send_Options(msg,text:match("^رفع ادمن (%d+)$"),"reply","܁𖠐︙تم ترقيته ادمن للمجموعه")  
...
Send_Options(msg,text:match("^تنزيل ادمن (%d+)$"),"reply","܁𖠐︙تم تنزيله من ادمنيه المجموعه")  
...
Send_Options(msg,text:match("^رفع مميز (%d+)$"),"reply","܁𖠐︙تم ترقيته مميز للمجموعه")  
...
Send_Options(msg,text:match("^تنزيل مميز (%d+)$") ,"reply","܁𖠐︙تم تنزيله من المميزين")  
...
send(msg.chat_id_, msg.id_, "\n܁𖠐︙لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(text:match("^حظر (%d+)$"),msg.chat_id_).."")
else
...
Send_Options(msg,text:match("^حظر (%d+)$") ,"reply","܁𖠐︙تم حظره من المجموعه")  
end,nil)   
end
...
Send_Options(msg,text:match("^الغاء حظر (%d+)$") ,"reply","܁𖠐︙تم الغاء حظره من هنا")  
...
send(msg.chat_id_, msg.id_, "\n܁𖠐︙لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(text:match("^كتم (%d+)$"),msg.chat_id_).."")
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,"܁𖠐︙عذرآ البوت ليس ادمن") 
return false  
...
Send_Options(msg,text:match("^كتم (%d+)$"),"reply","܁𖠐︙تم كتمه من هنا")  
end
...
Send_Options(msg,text:match("^الغاء كتم (%d+)$") ,"reply","܁𖠐︙تم الغاء كتمه من هنا")  
elseif text and text:match("^تقيد (%d+)$") and Admin(msg) then
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,"܁𖠐︙عذرآ البوت ليس ادمن") 
return false  
...
send(msg.chat_id_, msg.id_, "\n܁𖠐︙لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(text:match("^تقيد (%d+)$"),msg.chat_id_).."")
else
https.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..text:match("^تقيد (%d+)$"))
Send_Options(msg,text:match("^تقيد (%d+)$"),"reply","܁𖠐︙تم تقييده في المجموعه")  
end
...
Send_Options(msg,result.sender_user_id_,"reply", "܁𖠐︙تم تقيده لمدة ~ { "..TextEnd[2]..' '..TextEnd[3]..'}')
...
Send_Options(msg,text:match("^الغاء تقيد (%d+)$"),"reply","܁𖠐︙تم الغاء تقييده")  
...
KickGroup(result.chat_id_, result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","܁𖠐︙تم طرده من هنا")  
end,nil)
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
send(msg.chat_id_, msg.id_, "\n܁𖠐︙لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(text:match("^طرد (%d+)$"),msg.chat_id_).."")
else
...
Send_Options(msg,text:match("^طرد (%d+)$") ,"reply","܁𖠐︙تم طرده من هنا")  
end,nil)   
end
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","܁𖠐︙تم قفـل الفارسيه")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","܁𖠐︙تم قفـل الفشار")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","܁𖠐︙تم قفـل الدردشه")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","܁𖠐︙تم قفـل اضافة الاعضاء")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","܁𖠐︙تم قفـل دخول الاعضاء")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","܁𖠐︙تم قفـل البوتات")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status_Kick","܁𖠐︙تم قفـل البوتات")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","܁𖠐︙تم قفـل الاشعارات")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","܁𖠐︙تم قفـل التثبيت هنا")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","܁𖠐︙تم قفـل تعديل")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","܁𖠐︙تم قفـل جميع الاوامر")  
...
Send_Options(msg,msg.sender_user_id_,"Open_Status","܁𖠐︙تم فتح البوتات")  
elseif text == "فتح البوتات " and msg.reply_to_message_id_ == 0 and Admin(msg) then 
redis:del(bot_id.."Status:Lock:Bot:kick"..msg.chat_id_)  
...
Send_Options(msg,msg.sender_user_id_,"Open_Status","܁𖠐︙تم فتح الاشعارات")  
...
Send_Options(msg,msg.sender_user_id_,"Open_Status","܁𖠐︙تم فتح التثبيت هنا")  
...
Send_Options(msg,msg.sender_user_id_,"Open_Status","܁𖠐︙تم فتح تعديل")  
...
redis:set(bot_id.."Status:Lock:edit"..msg.chat_id_,true) 
redis:set(bot_id.."Status:Lock:Bot:kick"..msg.chat_id_,"kick")  
send(msg.chat_id_, msg.id_,"܁𖠐︙تم تفعيل الحمايه القصوى") 
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم تعطيل امر اطردني") 
...
redis:set(bot_id.."Status:Lock:Ban:Group"..msg.chat_id_,"true")
send(msg.chat_id_, msg.id_, '܁𖠐︙تم تعطيل - ( الحظر - الطرد ) ')
...
send(msg.chat_id_, msg.id_, '܁𖠐︙تم تفعيل - ( الحظر - الطرد ) ')
elseif text == "تعطيل الرفع" and Constructor(msg) or text == "تعطيل الترقيه" and Constructor(msg) then
redis:set(bot_id.."Status:Cheking:Seted"..msg.chat_id_,"true")
send(msg.chat_id_, msg.id_, '܁𖠐︙تم تعطيل رفع - ( الادمن - المميز ) ')
...
send(msg.chat_id_, msg.id_, '܁𖠐︙تم تفعيل رفع - ( الادمن - المميز ) ')
...
send(msg.chat_id_,msg.id_,"܁𖠐︙التثبيت مقفل من قبل المنشئين")  
return false end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub("-100",""),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"܁𖠐︙تم تثبيت الرساله بنجاح")   
redis:set(bot_id.."Get:Id:Msg:Pin"..msg.chat_id_,msg.reply_to_message_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"܁𖠐︙البوت ليس ادمن هنا")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"܁𖠐︙ليست لدي صلاحية التثبيت .")  
end;end,nil) 
...
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"܁𖠐︙تم الغاء تثبيت الرساله بنجاح")   
...
send(msg.chat_id_, msg.id_,'܁𖠐︙تم طرد الحسابات المحذوفه')
end,nil)
end
elseif text ==("مسح المطرودين") and Admin(msg) then    
local function delbans(extra, result)  
if not msg.can_be_deleted_ == true then  
send(msg.chat_id_, msg.id_, "܁𖠐︙ يرجى ترقيتي ادمن هنا") 
return false
end  
local num = 0 
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ تم الغاء الحظر عن *: "..num.." * شخص") 
end    
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, "܁𖠐︙لا توجد بوتات في المجموعه")
else
send(msg.chat_id_, msg.id_,"\n܁𖠐︙عدد البوتات هنا : "..c.."\n܁𖠐︙عدد البوتات التي هي ادمن : "..x.."\n܁𖠐︙تم طرد - "..(c - x).." - بوتات ") 
end 
end,nil)  
elseif text == "مسح الرابط" and Admin(msg) or text == "حذف الرابط" and Admin(msg) then
send(msg.chat_id_,msg.id_,"܁𖠐︙تم ازالة رابط المجموعه")           
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم ازالة صورة المجموعه") 
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم ازالة ترحيب المجموعه") 
elseif text == "مسح القوانين" and Admin(msg) or text == "حذف القوانين" and Admin(msg) then  
send(msg.chat_id_, msg.id_,"܁𖠐︙تم ازالة قوانين المجموعه")  
...
send(msg.chat_id_, msg.id_, '܁𖠐︙تم ازالة كليشة الايدي ')
...
send(msg.chat_id_, msg.id_,'܁𖠐︙تم مسح جميع رسائلك ') 
...
send(msg.chat_id_, msg.id_,'܁𖠐︙تم مسح جميع تعديلاتك ') 
elseif text == 'مسح جهاتي' then
redis:del(bot_id..'Num:Add:Memp'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_, msg.id_,'܁𖠐︙تم مسح جميع جهاتك المضافه ') 
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم وضع عدد التكرار : "..text:match("^وضع تكرار (%d+)$").."")  
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم وضع زمن التكرار : "..text:match("^وضع زمن التكرار (%d+)$").."") 
elseif text == "ضع رابط" and Admin(msg) or text == "وضع رابط" and Admin(msg) then
send(msg.chat_id_,msg.id_,"܁𖠐︙ارسل رابط المجموعه او رابط قناة المجموعه")
...
send(msg.chat_id_,msg.id_,"܁𖠐︙ارسل الصوره لوضعها") 
...
send(msg.chat_id_,msg.id_,"܁𖠐︙ارسل الان الوصف")
...
send(msg.chat_id_,msg.id_,"܁𖠐︙ارسل لي الترحيب الان".."\n܁𖠐︙تستطيع اضافة مايلي !\n܁𖠐︙دالة عرض الاسم »{`name`}\n܁𖠐︙دالة عرض المعرف »{`user`}") 
...
send(msg.chat_id_,msg.id_,"܁𖠐︙ارسل لي القوانين الان")  
...
send(msg.chat_id_,msg.id_,"܁𖠐︙ البوت ليس ادمن يرجى ترقيتي !")  
return false  
end 
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"܁𖠐︙ ليست لدي صلاحية تغير اسم المجموعه")  
else
send(msg.chat_id_,msg.id_,"܁𖠐︙ تم تغيير اسم المجموعه الى {["..Name.."]}")  
end
end,nil) 
elseif text == 'روابط الكروبات' and Dev_Casper(msg) then
local list = redis:smembers(bot_id..'ChekBotAdd') 
test = '܁𖠐︙روابط الكروبات \n\n'
for k,v in pairs(list) do 
...
if status_Link then
send(msg.chat_id_, msg.id_,"܁𖠐︙جلب الرابط معطل") 
return false  
end
...
Welcome = "܁𖠐︙لم يتم تعيين ترحيب للمجموعه"
end 
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم مسح قائمه المنع")  
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ارسل الكلمه الان")  
...
if #admins == i then 
local a = "\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n܁𖠐︙عدد البوتات التي هنا : "..n.." بوت"
local f = "\n܁𖠐︙عدد البوتات التي هي ادمن : "..t.."\n܁𖠐︙ملاحضه علامة النجمه يعني البوت ادمن - ★ \n"
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ارسل الان الامر الذي قمت بوضعه مكان الامر القديم")  
...
send(msg.chat_id_, msg.id_, "\n܁𖠐︙ارسل نوع الصلاحيه كما مطلوب منك :\n܁𖠐︙انواع الصلاحيات المطلوبه ← { عضو ، مميز  ، ادمن  ، مدير }") 
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ تم تغير رد المطور الى :"..Teext)
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ تم تغير رد المنشئ الاساسي الى :"..Teext)
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ تم تغير رد المنشئ الى :"..Teext)
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم مسح قائمه ردود المدير")
...
if #list == 0 then
text = "܁𖠐︙عذرا لا يوجد ردود للمدير في المجموعه"
end
send(msg.chat_id_, msg.id_,"["..text.."]")
elseif text == "اضف رد" and Owner(msg) then
send(msg.chat_id_, msg.id_,"܁𖠐︙ارسل الان الكلمه لاضافتها في ردود المدير ")
redis:set(bot_id.."Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
elseif text == "حذف رد" and Owner(msg) then
send(msg.chat_id_, msg.id_,"܁𖠐︙ارسل الان الكلمه لحذفها من ردود المدير")
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم حذف ردود المطور")
...
if #list == 0 then
text = "܁𖠐︙لا توجد ردود للمطور"
end
send(msg.chat_id_, msg.id_,"["..text.."]")
elseif text == "اضف رد للكل" and Dev_Casper(msg) then 
send(msg.chat_id_, msg.id_,"܁𖠐︙ارسل الان الكلمه لاضافتها في ردود المكور ")
redis:set(bot_id.."Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
elseif text == "حذف رد للكل" and Dev_Casper(msg) then 
send(msg.chat_id_, msg.id_,"܁𖠐︙ارسل الان الكلمه لحذفها من ردود المطور")
...
if (result.id_) then
if Dev_Casper_User(result.id_) == true then
send(msg.chat_id_, msg.id_,"܁𖠐︙ لا تستطيع تنزيل المطور الاساسي")
return false 
end
...
send(msg.chat_id_, msg.id_,"\n܁𖠐︙تم تنزيل الشخص من الرتب التاليه \n܁𖠐︙ { "..dev..""..crr..""..cr..""..own..""..mod..""..vip.." } \n")
else
send(msg.chat_id_, msg.id_,"\n܁𖠐︙ليس لديه رتب حتى استطيع تنزيله \n")
end
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ رتبتك في البوت : "..rtp)
elseif text == "اسمي"  then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
if result.first_name_  then
first_name = "܁𖠐︙ اسمك الاول : `"..(result.first_name_).."`"
else
first_name = ""
end   
if result.last_name_ then 
last_name = "܁𖠐︙ اسمك الثاني ← : `"..result.last_name_.."`" 
else
last_name = ""
end      
...
local taha = "܁𖠐︙ عدد الادمنيه : "..data.administrator_count_..
"\n܁𖠐︙ عدد المطرودين : "..data.kicked_count_..
"\n܁𖠐︙ عدد الاعضاء : "..data.member_count_..
"\n܁𖠐︙ عدد رسائل الكروب : "..(msg.id_/2097152/0.5)..
"\n܁𖠐︙ اسم المجموعه : ["..ta.title_.."]"
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم حبيبي حغادر") 
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم حبيبي حغادر") 
send(GP_ID[2], 0,"܁𖠐︙ تم مغادرة المجموعه بامر من مطور البوت") 
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم تعطيل الاذاعه من قبل المطور الاساسي !")
return false end
redis:setex(bot_id.."Broadcasting:Users" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"܁𖠐︙ارسل لي المنشور الان\n܁𖠐︙يمكنك ارسال -{ صوره - ملصق - متحركه - رساله }\n܁𖠐︙لالغاء الاذاعه ارسل : الغاء") 
return false
...
send(msg.chat_id_, msg.id_,"*\n܁𖠐︙اعدادات المجموعه "..
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"..
"\n܁𖠐︙علامة ال (✔️) تعني مفعل"..
"\n܁𖠐︙علامة ال (✖) تعني معطل"..
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"..
"\n܁𖠐︙الروابط "..lock_links..
"\n".."܁𖠐︙الكلايش "..lock_spam..
"\n".."܁𖠐︙الكيبورد "..lock_inlin..
"\n".."܁𖠐︙الاغاني "..lock_vico..
"\n".."܁𖠐︙المتحركه "..lock_gif..
"\n".."܁𖠐︙الملفات "..lock_file..
"\n".."܁𖠐︙الدردشه "..lock_text..
...
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"..
"\n".."܁𖠐︙التثبيت "..lock_pin..
"\n".."܁𖠐︙الاشعارات "..lock_tagservr..
"\n".."܁𖠐︙الماركدون "..lock_mark..
"\n".."܁𖠐︙التعديل "..lock_edit..
"\n".."܁𖠐︙الالعاب "..lock_geam..
"\n".."܁𖠐︙التكرار "..flood..
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"..
...
"\n".."܁𖠐︙الطرد "..Banusers..
"\n".."܁𖠐︙الايدي "..IdPhoto..
"\n".."܁𖠐︙الايدي بالصوره "..IdPyPhoto..
"\n".."܁𖠐︙اطردني "..KickMe..
"\n".."܁𖠐︙ردود المدير "..ReplyManager..
"\n".."܁𖠐︙ردود المطور "..ReplySudo..
"\n".."܁𖠐︙اوامر التحشيش "..FunGroup..
"\n".."܁𖠐︙جلب الرابط "..Link_Group..
"\n".."܁𖠐︙عدد التكرار ← {"..Num_Flood.."}\n\n.*")     
elseif text == 'تعين الايدي' and Owner(msg) then
redis:setex(bot_id.."Redis:Id:Group"..msg.chat_id_..""..msg.sender_user_id_,240,true)  
send(msg.chat_id_, msg.id_,[[܁𖠐︙ارسل الان النص܁𖠐︙يمكنك اضافه :܁𖠐︙`#username` » اسم المستخدم܁𖠐︙`#msgs` » عدد الرسائل܁𖠐︙`#photos` » عدد الصور܁𖠐︙`#id` » ايدي المستخدم܁𖠐︙`#auto` » نسبة التفاعل܁𖠐︙`#stast` » رتبة المستخدم ܁𖠐︙`#edit` » عدد السحكات܁𖠐︙`#game` » عدد المجوهرات܁𖠐︙`#AddMem` » عدد الجهات܁𖠐︙`#Description` » تعليق الصوره܁𖠐︙ قناة الكلايش • @Gverr
]])
return false  
...
send(msg.chat_id_, msg.id_,'܁𖠐︙ تم تغير الايدي ارسل ايدي لرؤيته')
end
...
sendPhoto(msg.chat_id_,msg.id_,taha.photos_[0].sizes_[1].photo_.persistent_id_,'܁𖠐︙'..Description..'\n܁𖠐︙ايديك ← '..Id..'\n܁𖠐︙معرفك ← '..UserName_User..'\n܁𖠐︙رتبتك ← '..Status_Gps..'\n܁𖠐︙رسائلك ← '..NumMsg..'\n܁𖠐︙السحكات ← '..NumMessageEdit..' \n܁𖠐︙تتفاعلك ← '..TotalMsg..'\n܁𖠐︙ مجوهراتك ← '..Num_Games)
end
else
send(msg.chat_id_, msg.id_,'\n*܁𖠐︙ايديك ← '..Id..'\n܁𖠐︙معرفك ← *['..UserName_User..']*\n܁𖠐︙رتبتك ← '..Status_Gps..'\n܁𖠐︙رسائلك ← '..NumMsg..'\n܁𖠐︙السحكات ← '..NumMessageEdit..' \n܁𖠐︙تتفاعلك ← '..TotalMsg..'\n܁𖠐︙ مجوهراتك ← '..Num_Games..'*') 
end
...
send(msg.chat_id_, msg.id_,'܁𖠐︙تستطيع حذف *(1000)* رساله فقط') 
return false  
end  
lk_keko = {[0]=msg.id_}
...
send(msg.chat_id_, msg.id_,'܁𖠐︙تم ازالة *- '..Msg_Num..'* رساله من المجموعه')  
    ...
    tdcli_function({ID = "GetMessages",chat_id_ = msg.chat_id_,message_ids_ = lk_keko},function(arg,data)
        ...
        for i=0 ,data.total_count_ do
            if data.messages_[i] and data.messages_[i].content_ and data.messages_[i].content_.ID ~= "MessageText" then
                lk_keko2[new] = data.messages_[i].id_
                new = new + 1
            end
        end
        Delete_Message(msg.chat_id_,lk_keko2)
    end,nil)  
    send(msg.chat_id_, msg.id_,"܁𖠐︙تم ازالة 100 من وسائط 🛡") 
elseif text and (text == "تنظيف جميع الرسائل المعدله" or text == "تنظيف الرسائل المعدلة" or text == "تنظيف الرسائل المعدله") and Admin(msg) then   
    ...
    send(msg.chat_id_, msg.id_,'܁𖠐︙تم ازالة 100 رساله معدلة 🛡') 
...
if data.first_name_ == false then
send(msg.chat_id_, msg.id_,'܁𖠐︙ الحساب محذوف لا توجد معلوماته ')
return false
end
if data.username_ then
UserName_User = '@'..data.username_
...
send(msg.chat_id_, msg.id_,'\n*܁𖠐︙ايديه ← '..Id..'\n܁𖠐︙رسائله ← '..NumMsg..'\n܁𖠐︙معرفه ← *['..UserName_User..']*\n܁𖠐︙تفاعله ← '..TotalMsg..'\n܁𖠐︙رتبته ← '..Status_Gps..'\n܁𖠐︙تعديلاته ← '..NumMessageEdit..'\n܁𖠐︙جهاته ← '..Add_Mem..'*') 
end,nil)   
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Status, nil)
return false
...
send(msg.chat_id_, msg.id_,'܁𖠐︙لا يوجد حساب بهاذا المعرف')
end
end
...
send(msg.chat_id_, msg.id_,"܁𖠐︙اسرع واحد يدز هاذا السمايل ? ~ {`"..SM.."`}")
return false
end
...
send(msg.chat_id_, msg.id_,"܁𖠐︙اسرع واحد يرتبها ~ {"..name.."}")
return false
end
...
send(msg.chat_id_, msg.id_,"܁𖠐︙اسرع واحد يحل الحزوره ↓\n {"..name.."}")
return false
end
...
send(msg.chat_id_, msg.id_,"܁𖠐︙اسرع واحد يدز معنى السمايل ~ {"..name.."}")
return false
end
...
send(msg.chat_id_, msg.id_,"܁𖠐︙اسرع واحد يدز العكس ~ {"..name.."}")
return false
end
...
send(msg.chat_id_, msg.id_,"\n܁𖠐︙اهلا بك عزيزي في لعبة التخمين :\nٴ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n".."܁𖠐︙ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n".."܁𖠐︙سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ")
...
*➀       ➁     ➂      ➃      ➄     ➅
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊܁𖠐︙اختر لأستخراج المحيبس الايد التي تحمل المحيبس ܁𖠐︙الفائز يحصل على { 3 } من النقاط *
]])
...
name = string.gsub(name,"⌛️","⏳⏳⏳⏳⏳⏳⌛️⏳⏳")
name = string.gsub(name,"📅","??📆📆📆📆📆📅📆📆")
send(msg.chat_id_, msg.id_,"܁𖠐︙اسرع واحد يدز الاختلاف ~ {"..name.."}")
return false
end
...
send(msg.chat_id_, msg.id_,"܁𖠐︙اسرع واحد يكمل المثل ~ {"..name.."}")
return false
end
...
send(msg.chat_id_, msg.id_,[[*܁𖠐︙توجد ← 5 اوامر في البوت
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙ارسل { م1 } ← اوامر الحمايه܁𖠐︙ارسل { م2 } ← اوامر الادمنيه܁𖠐︙ارسل { م3 } ← اوامر المدراء܁𖠐︙ارسل { م4 } ← اوامر المنشئين܁𖠐︙ارسل { م5 } ← اوامر مطورين البوت
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙قناة البوت ←* @Cispar
]]) 
elseif text == 'م1' and Admin(msg) then
send(msg.chat_id_, msg.id_,[[*܁𖠐︙اوامر الحمايه اتبع مايلي ...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙قفل ، فتح ← الامر ܁𖠐︙تستطيع قفل حمايه كما يلي ...܁𖠐︙← { بالتقيد ، بالطرد ، بالكتم }
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙الروابط܁𖠐︙المعرف܁𖠐︙التاك܁𖠐︙الشارحه܁𖠐︙التعديل܁𖠐︙التثبيت܁𖠐︙المتحركه܁𖠐︙الملفات܁𖠐︙الصور
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙الماركداون܁𖠐︙البوتات܁𖠐︙التكرار܁𖠐︙الكلايش܁𖠐︙السيلفي܁𖠐︙الملصقات܁𖠐︙الفيديو܁𖠐︙الانلاين܁𖠐︙الدردشه
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙التوجيه܁𖠐︙الاغاني܁𖠐︙الصوت܁𖠐︙الجهات܁𖠐︙الاشعارات
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙قناة البوت ←* @Cispar
]]) 
elseif text == 'م2' and Admin(msg) then
send(msg.chat_id_, msg.id_,[[*܁𖠐︙اوامر ادمنية المجموعه ...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙رفع، تنزيل ← مميز܁𖠐︙تاك للكل ، عدد الكروب܁𖠐︙كتم ، حظر ، طرد ، تقيد܁𖠐︙الغاء كتم ، الغاء حظر ، الغاء تقيد܁𖠐︙منع ، الغاء منع 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙عرض القوائم كما يلي ...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙المكتومين܁𖠐︙المميزين ܁𖠐︙قائمه المنع܁𖠐︙الصلاحيات
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙تثبيت ، الغاء تثبيت܁𖠐︙الرابط ، الاعدادات܁𖠐︙الترحيب ، القوانين܁𖠐︙تفعيل ، تعطيل ← الترحيب܁𖠐︙تفعيل ، تعطيل ← الرابط܁𖠐︙اضف صلاحيه ، مسح صلاحيه ܁𖠐︙جهاتي ،ايدي ، رسائلي܁𖠐︙سحكاتي ، مجوهراتي܁𖠐︙كشف البوتات
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙وضع ، ضع ← الاوامر التاليه ܁𖠐︙اسم ، رابط ، صوره܁𖠐︙قوانين ، وصف ، ترحيب
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙حذف ، مسح ← الاوامر التاليه܁𖠐︙قائمه المنع ، المحظورين ܁𖠐︙المميزين ، المكتومين ، القوانين܁𖠐︙المطرودين ، البوتات ، الصوره܁𖠐︙الصلاحيات ، الرابط
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙قناة البوت ←* @Cispar
]]) 
elseif text == 'م3' and Owner(msg) then
send(msg.chat_id_, msg.id_,[[*܁𖠐︙اوامر المدراء في المجموعه
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙رفع ، تنزيل ← ادمن܁𖠐︙الادمنيه ܁𖠐︙رفع، كشف ← القيود܁𖠐︙تنزيل الكل ← { بالرد ، بالمعرف }
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙لتغيير رد الرتب في البوت
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙تغير رد ← {اسم الرتبه والنص} ܁𖠐︙المطور ، المنشئ الاساسي܁𖠐︙المنشئ ، المدير ، الادمن܁𖠐︙المميز ، العضو
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙تفعيل ، تعطيل ← الاوامر التاليه ↓
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙الايدي ، الايدي بالصوره܁𖠐︙ردود المطور ، ردود المدير܁𖠐︙اطردني ، الالعاب ، الرفع܁𖠐︙الحظر ، الرابط ، اوامر التحشيش
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙تعين ، مسح ←{ الايدي }܁𖠐︙رفع الادمنيه ، مسح الادمنيه܁𖠐︙ردود المدير ، مسح ردود المدير܁𖠐︙اضف ، حذف ← { رد }܁𖠐︙تنظيف ← { عدد }
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙قناة البوت ←* @Cispar
]]) 
elseif text == 'م4' and Constructor(msg) then
send(msg.chat_id_, msg.id_,[[*܁𖠐︙اوامر المنشئ الاساسي
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙رفع ، تنزيل ←{ منشئ }܁𖠐︙المنشئين ، مسح المنشئين
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙اوامر المنشئ المجموعه
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙رفع ، تنزيل ← { مدير }܁𖠐︙المدراء ، مسح المدراء܁𖠐︙اضف رسائل ← { بالرد او الايدي }܁𖠐︙اضف مجوهرات ← { بالرد او الايدي }܁𖠐︙اضف ، حذف ← { امر }܁𖠐︙الاوامر المضافه ، مسح الاوامر المضافه
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙قناة البوت ←* @Cispar
]]) 
elseif text == 'م5' and DeveloperBot(msg)  then
send(msg.chat_id_, msg.id_,[[*܁𖠐︙اوامر المطور الاساسي  
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙حظر عام ، الغاء العام܁𖠐︙اضف ، حذف ← { مطور } ܁𖠐︙قائمه العام ، مسح قائمه العام܁𖠐︙المطورين ، مسح المطورين
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙اضف ، حذف ← { رد للكل }܁𖠐︙وضع ، حذف ← { كليشه المطور } ܁𖠐︙مسح ردود المطور ، ردود المطور ܁𖠐︙تحديث ،  تحديث السورس ܁𖠐︙تعين عدد الاعضاء ← { العدد }
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙تفعيل ، تعطيل ← { الاوامر التاليه ↓}܁𖠐︙البوت الخدمي ، المغادرة ، الاذاعه܁𖠐︙ملف ← { اسم الملف }
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙مسح جميع الملفات ܁𖠐︙المتجر ، الملفات
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙اوامر المطور في البوت
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙تفعيل ، تعطيل ، الاحصائيات܁𖠐︙رفع، تنزيل ← { منشئ اساسي }܁𖠐︙مسح الاساسين ، المنشئين الاساسين ܁𖠐︙غادر ، غادر ← { والايدي }܁𖠐︙اذاعه ، اذاعه بالتوجيه ، اذاعه بالتثبيت܁𖠐︙اذاعه خاص ، اذاعه خاص بالتوجيه 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙قناة البوت ←* @Cispar
]]) 
...
send(msg.chat_id_, msg.id_,[[*܁𖠐︙قائمه الالعاب البوت
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙لعبة المختلف » المختلف܁𖠐︙لعبة الامثله » امثله܁𖠐︙لعبة العكس » العكس܁𖠐︙لعبة الحزوره » حزوره܁𖠐︙لعبة المعاني » معاني܁𖠐︙لعبة البات » بات܁𖠐︙لعبة التخمين » خمن܁𖠐︙لعبه الاسرع » الاسرع܁𖠐︙لعبة السمايلات » سمايلات
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉܁𖠐︙مجوهراتي ← لعرض عدد الارباح܁𖠐︙بيع مجوهراتي ← { العدد } ← لبيع كل مجوهره مقابل {50} رساله
*]]) 
elseif text == 'رسائلي' then
local NumMsgg1 = redis:get(bot_id..'Num:Message:Userr'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local nummsg = redis:get(bot_id..'Num:Message:User'..msg.chat_id_..':'..msg.sender_user_id_) or 1 
local NumMsg = (NumMsgg1 + nummsg)
send(msg.chat_id_, msg.id_,'܁𖠐︙عدد رسائلك هنا *~ '..NumMsg..'*') 
...
send(msg.chat_id_,msg.id_,"܁𖠐︙تم خصم *~ { "..NUMPY.." }* من مجوهراتك \n܁𖠐︙وتم اضافة* ~ { "..(NUMPY * 50).." } رساله الى رسالك *")
end 
return false 
...
send(msg.chat_id_, msg.id_, "܁𖠐︙ارسل لي عدد الرسائل الان") 
return false
...
send(msg.chat_id_, msg.id_, "܁𖠐︙ارسل لي عدد المجوهرات الان") 
elseif text and text:match("^اضف مجوهرات (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
function reply(extra, result, success)
redis:incrby(bot_id.."Num:Add:Games"..msg.chat_id_..result.sender_user_id_,text:match("^اضف مجوهرات (%d+)$"))  
send(msg.chat_id_, msg.id_,"܁𖠐︙تم اضافه عدد مجوهرات : "..text:match("^اضف مجوهرات (%d+)$").." ")  
end
...
send(msg.chat_id_, msg.id_, "܁𖠐︙تم اضافه عدد الرسائل : "..text:match("^اضف رسائل (%d+)$").." ")  
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},reply, nil)
return false
...
send(msg.chat_id_, msg.id_, "\n܁𖠐︙ عذرا لا استطيع طرد ( "..Get_Rank(msg.sender_user_id_,msg.chat_id_).." )")
return false
end
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=msg.sender_user_id_,status_={ID="ChatMemberStatusKicked"},},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,"܁𖠐︙ ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !") 
return false  
end
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ عذرا لا استطيع طرد ادمنية المجموعه") 
return false  
end
if data and data.ID and data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"܁𖠐︙ تم طردك من المجموعه ") 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_,"܁𖠐︙ امر اطردني تم تعطيله من قبل المدراء ") 
end
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ الحظر العام ← "..GBan.."\n܁𖠐︙ الحظر ← "..Ban.."\n܁𖠐︙ الكتم ← "..Muted)
else
send(msg.chat_id_, msg.id_,"܁𖠐︙ المعرف غلط")
end
end
...
if num2 == 0 then
send(msg.chat_id_, msg.id_,"܁𖠐︙ لا توجد ادمنية ليتم رفعهم") 
else
send(msg.chat_id_, msg.id_,"܁𖠐︙ تمت ترقية - "..num2.." من ادمنية المجموعه") 
end
end,nil)   
...
if b.first_name_ == false then
send(msg.chat_id_, msg.id_,"܁𖠐︙ حساب المنشئ محذوف")
return false  
end
local UserName = (b.username_ or "Cispar")
send(msg.chat_id_, msg.id_,"܁𖠐︙منشئ المجموعه ~ ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
local UserName = (b.username_ or "Cispar")
send(msg.chat_id_, msg.id_,"܁𖠐︙تم ترقية منشئ المجموعه ← ["..b.first_name_.."](T.me/"..UserName..")")  
...
send(msg.chat_id_, msg.id_,'܁𖠐︙لا تستطيع تفعيل المجموعه بسبب قلة عدد اعضاء المجموعه يجب ان يكون اكثر من *:'..(redis:get(bot_id..'Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if redis:sismember(bot_id..'ChekBotAdd',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'܁𖠐︙تم تفعيل المجموعه مسبقا')
else
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data) 
local admins = data.members_
for i=0 , #admins do
if data.members_[i].status_.ID == "ChatMemberStatusCreator" then
owner_id = admins[i].user_id_
redis:sadd(bot_id.."President:Group"..msg.chat_id_,owner_id)
end
end
end,nil)   
Send_Options(msg,result.id_,'reply_Add','܁𖠐︙تم تفعيل مجموعه '..chat.title_..'')
...
sendText(Id_Dev,'܁𖠐︙تم تفعيل مجموعه جديده\n'..'\n܁𖠐︙بواسطة : '..Name..''..'\n܁𖠐︙ايدي المجموعه : `'..IdChat..'`'..'\n܁𖠐︙عدد اعضاء المجموعه *: '..NumMember..'*'..'\n܁𖠐︙اسم المجموعه : ['..NameChat..']'..'\n܁𖠐︙الرابط : ['..LinkGp..']',0,'md')
end
end
end,nil) 
end,nil) 
...
send(msg.chat_id_, msg.id_,'܁𖠐︙المجموعه بالتاكيد معطله')
else
Send_Options(msg,result.id_,'reply_Add','܁𖠐︙تم تعطيل مجموعه '..chat.title_..'')
redis:srem(bot_id..'ChekBotAdd',msg.chat_id_)  
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub('"',"") 
...
if not Dev_Casper(msg) then
sendText(Id_Dev,'܁𖠐︙تم تعطيل مجموعه جديده\n'..'\n܁𖠐︙بواسطة : '..Name..''..'\n܁𖠐︙ايدي المجموعه : `'..IdChat..'`\n܁𖠐︙اسم المجموعه : ['..NameChat..']',0,'md')
end
end
end,nil) 
end,nil) 
...
Send_Options(msg,msg.sender_user_id_,'reply_Add','܁𖠐︙تم تفعيل مجموعه '..chat.title_..'')
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data) 
local admins = data.members_
for i=0 , #admins do
if data.members_[i].status_.ID == "ChatMemberStatusCreator" then
...
local NameChat = NameChat:gsub("}","") 
if not Dev_Casper(msg) then
sendText(Id_Dev,'܁𖠐︙تم تفعيل مجموعه جديده\n܁𖠐︙بواسطة : '..Name..'\n܁𖠐︙موقعه في المجموعه : '..Status_Rt..'\n܁𖠐︙ايدي المجموعه : `'..msg.chat_id_..'`\n܁𖠐︙عدد اعضاء المجموعه *: '..NumMember..'*\n܁𖠐︙اسم المجموعه : ['..NameChat..']\n܁𖠐︙الرابط : ['..LinkChat..']',0,'md')
end
end
end
end,nil)   
...
--             send(msg.chat_id_, msg.id_,"܁𖠐︙لتلح يا حلو 😉")  
        end 
        return false
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم ازالة هاذا ← { "..text.." }")  
else
send(msg.chat_id_, msg.id_,"܁𖠐︙لا يوجد امر بهاذا الاسم")  
end
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ارسل الامر الجديد ليتم وضعه مكان القديم")  
...
send(msg.chat_id_, msg.id_,"܁𖠐︙تم حفظ الامر باسم ← { "..text..' }')  
...
if #list == 0 then
Send_Options(result,result.sender_user_id_,"reply","܁𖠐︙قام بالتعديل على الميديا")  
else
tt = "\n܁𖠐︙يا منشئين\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do
local username = redis:get(bot_id.."Save:Username" .. v)
...
if Text_Filter then    
Delete_Message(result.chat_id_, {[0] = data.message_id_})     
Send_Options(result,result.sender_user_id_,"reply","܁𖠐︙"..Text_Filter)  
return false
end
end
end
