...
if Status or Dev_Casper(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if hash or Dev_Casper(msg) or DeveloperBot(msg) or Bot(msg) then  
return true 
else 
return false 
end 
...
if hash or Dev_Casper(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or Dev_Casper(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or Dev_Casper(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Owner(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or Dev_Casper(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Owner(msg) or Admin(msg) or Bot(msg) then     
return true 
else 
return false 
end 
...
send(msg.sender_user_id_,msg.id_,'܁𖠐︙تم ارسال رسالتك الى المطور ← { [tahaj20] }')    
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
elseif text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_Casper(msg) then
local url,res = https.request('https://asdpro13.ml/Casper.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.infoo ~= true then
send(msg.chat_id_,msg.id_,'\n܁𖠐︙عليك الاشتراك في قناة البوت \n܁𖠐︙قناة البوت ← { @Cispar }') 
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
elseif text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_Casper(msg) then
local url,res = https.request('https://asdpro13.ml/Casper.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.infoo ~= true then
send(msg.chat_id_,msg.id_,'\n܁𖠐︙عليك الاشتراك في قناة البوت \n܁𖠐︙قناة البوت ← { @Cispar }') 
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^الغاء العام @(.*)$") }, FunctionStatus, nil)
elseif text and text:match("^اضف مطور @(.*)$") and Dev_Casper(msg) then
local url,res = https.request('https://asdpro13.ml/Casper.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.infoo ~= true then
send(msg.chat_id_,msg.id_,'\n܁𖠐︙عليك الاشتراك في قناة البوت \n܁𖠐︙قناة البوت ← { @Cispar }') 
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^اضف مطور @(.*)$")}, FunctionStatus, nil)
elseif text and text:match("^حذف مطور @(.*)$") and Dev_Casper(msg) then
local url,res = https.request('https://asdpro13.ml/Casper.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.infoo ~= true then
send(msg.chat_id_,msg.id_,'\n܁𖠐︙عليك الاشتراك في قناة البوت \n܁𖠐︙قناة البوت ← { @Cispar }') 
...
elseif text and text:match("^حذف مطور (%d+)$") and Dev_Casper(msg) then
local url,res = https.request('https://asdpro13.ml/Casper.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.infoo ~= true then
send(msg.chat_id_,msg.id_,'\n܁𖠐︙عليك الاشتراك في قناة البوت \n܁𖠐︙قناة البوت ← { @Cispar }') 
...
send(msg.chat_id_, msg.id_, "\n܁𖠐︙لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(userid,msg.chat_id_).."")
else
...
Send_Options(msg,userid,"reply","܁𖠐︙تم تقييده في المجموعه")  
end
...
send(msg.chat_id_, msg.id_,"܁𖠐︙ تم مغادرة المجموعه") 
